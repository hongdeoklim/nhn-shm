    ...
    <div class="form-group grid">
      <div class="overflow-x-auto">
        ...
        <div class="row-header"
             style="display: grid;"
          :style="{gridTemplateColumns:isPrint || isReadonly?'150fr 150fr 150fr 100fr 150fr 210fr 150fr':'40px 150fr 150fr 150fr 100fr 150fr 210fr 150fr'}" >
          ...
          <div class="row-header__item">평가구분</div>
          <div class="row-header__item">유해·위험요인</div>
          <div class="row-header__item">재해형태</div>
          <div class="row-header__item">관련법근거</div>
          <div class="row-header__item">현재 안전보건조치</div>
          <div class="row-header__item row-w0 flex-col">
            <div class="flex h-full w-full">
              <div class="flex-1 center-flex">빈도</div>
              <div class="flex-1 center-flex">강도</div>
              <div class="flex-1 center-flex">위험등급</div>
              <div class="flex-1 center-flex">No</div>
            </div>
          </div>
          <div class="row-header__item ">위험감소대책</div>
        </div>
          ...
          <div class="flex-1 p-2 bx">
            ...
            >
              <vs-select-item
                ...
                :value="item.value"
                :text="item.text"
                v-for="(item, index) in handleAppraisalType(row.input_1)"
              />
            </vs-select>
          </div>
          ...
          <div class="row-w0 p-0 flex">
            <div class="flex-1 p-2 bx">
              ...
              <vs-select
                ...
                v-model="row.input_6"
                :disabled="isReadonly"
                @change="handleChangeInput(indexRows, row.input_6, row.input_7, 'input_8')"
              >
                <vs-select-item
                  :key="index"
                  :value="item.value"
...
export default {
  name: 'TableRiskAppraisal',
  components: {DisasterClassSelector, CheckTypeASelector},
  props: {
    tableTitle: String,
    list: Array,
    isPrint: Boolean,
