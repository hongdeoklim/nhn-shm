    ...
    <vs-col class="w-1/2 pr-2 pb-4">
      ...
      >
        <template v-if="projectId" slot="tools" :set="lv = getLevel">
          ...
          <vs-button class="ml-2" type="border" color="secondary" @click="dataTypeChangeForGraph2('detail')">점검대상</vs-button>
        </template>
      </monthly-comparison-card>
    </vs-col>
    ...
    <vs-col class="w-1/2 pl-2 pb-4">
      ...
      >
        <template v-if="projectId" slot="tools" :set="lv = getLevel">
          ...
          <vs-button class="ml-2" type="border" color="secondary" @click="dataTypeChangeForGraph3('detail')">점검대상</vs-button>
        </template>
      </daily-comparison-card>
    </vs-col>
  </vs-row>
...
export default {
  ...
  methods: {
    ...
    async loadGraph2 () {
      ...
      let summaryKey1 = ['작업장합동점검_점검대상', 'count']
      if (dataType === 'field') {
        summaryKey1 = ['작업장합동점검_현장명', 'count']
      }
