...
export default {
  ...
  methods: {
    ...
    async loadGraph2() {
      ...
      let summaryKey1 = ["정기위험성평가_재해형태", "count"];
      if (dataType === "field") {
        summaryKey1 = ["정기위험성평가_현장명", "count"];
      }
