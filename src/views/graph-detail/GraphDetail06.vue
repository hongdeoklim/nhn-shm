...
export default {
  ...
  data() {
    return {
      ...
      graph2: {
        ...
        unit: "",
        heads: [{ name: "No." }, { name: "현장명" }, { name: "교육횟수" }, { name: "전월대비 증감" }],
        list: [],
        dataType: this.$route.params.proj_id ? "detail" : "project",
      },
      graph3: {
        title: "기간별 안전보건 교육 현황",
        unit: "",
  ...
  methods: {
    ...
    async loadGraph2() {
      ...
      let summaryKey1 = ["안전보건교육_재해형태", "count"];
      if (dataType === "field") {
        summaryKey1 = ["안전보건교육_현장명", "count"];
      }
      ...
      if (dataType === "company") {
        this.graph2.heads = [{ name: "No." }, { name: "관련부서" }, { name: "교육횟수" }, { name: "전월대비 증감" }];
        ...
        this.graph2.heads = [{ name: "No." }, { name: "현장명" }, { name: "교육횟수" }, { name: "전월대비 증감" }];
      } else if (dataType === "detail") {
        this.graph2.heads = [{ name: "No." }, { name: "재해형태" }, { name: "건" }, { name: "전월대비 증감" }];
      }
