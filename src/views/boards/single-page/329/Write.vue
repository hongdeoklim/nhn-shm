<template>
  <div>
    <!-- 날짜 -->
    <div v-if="viewForm" class="absolute top-0 flex items-center gap-4" :class="[!isPrint && 'py-6']" style="left: calc(270px + 1.5rem)">
    ...
    <!--기본정보-->
    <field-select-module v-model="form.stdInfo" :board="board" :is-print="isPrint" @selectField="onSelectField" />
