...
export default {
  ...
  data() {
    return {
      checkTarget: ["인력배치", "품질관리", "사전준비 및 조사", "현장 및 주변시설", "현장시설물", "떨어짐 재해예방", "토공사(일반사항)", "흙막이 지보공", "굴착 비탈면 및 지반", "거푸집 동바리", "화재·폭발 재해예방"],
      ...
      form: {
        ...
        inspectData_11: inspectData.inspectData_11,
      },
    };
  },
  created () {
  ...
  mounted() {
    ...
    label.innerHTML = "해빙기 건설현장 자율점검표";
  },
};
</script>
