  ...
  <div>
    ...
    <div class="grid grid-cols-12 gap-x-6 gap-y-4 mt-4">
      <div class="col-span-4 flex items-center">
        <div class="label-text mr-4">자체평가명</div>
      ...
      <div class="col-span-4 flex items-center">
        ...
        <vs-select  v-else class="w-full flex-1" v-model="form.inputA_3" autocomplete :disabled="board.readonly">
          <vs-select-item v-for="(item, index) in formA3Option[form.inputA_2]" :value="item" :text="item" :key="item"/>
        </vs-select>
      </div>
    </div>
    ...
    <div class="grid grid-cols-12 gap-x-6 gap-y-4 mt-4">
      ...
      <div class="col-span-4 flex items-center">
        <div class="label-text mr-4">자체평가일</div>
      ...
      <div class="col-span-4 flex items-center">
        <div class="label-text mr-4">자체평가 계획</div>
      ...
      <!-- 세번째 줄 -->
      <div class="col-span-4 flex items-center">
        <div class="label-text mr-4">자체평가 내용에 반영한 재해형태</div>
      ...
      <div class="col-span-4 flex items-center">
        <div class="label-text mr-4">자체평가 내용</div>
