<template>
  <div v-if="!isPrint">
    ...
    <field-select-module
      ...
      :options="[
        { type: 'date', label: projectId === 7 ? '해당기간' : '점검일' },
    ...
    <table-custom
      ...
      title="장비정보"
      :tableData="[
        { id: 'input1', title: '장비명', type: 'text', placeholder: '내용' },
        { id: 'input2', title: '제조사 또는 모델명', type: 'text', placeholder: '내용' },
        { id: 'input3', title: '장비 규격(정격하중 또는 인양하중 등)', type: 'text', placeholder: '내용' },
      ]"
      :mobile="['input1', 'input2']"
...
export default {
  ...
  data() {
    return {
      inspectionTitle: ["공통", "굴착기", "고소작업대", "이동식 크레인", "트럭(화물운반트럭, 덤프트럭)", "타워크레인"],
      ...
      form: {
        ...
        inspectList_5: inspectData.inspectTable_5,
        inspectList_6: inspectData.inspectTable_6,
