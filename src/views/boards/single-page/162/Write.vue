<template>
  <div v-if="!isPrint">
    ...
    <!--    위험성 평가표-->
    <table-risk-appraisal class="mt-5" :table-title="'위험성 평가표'" :list="form.riskAppraisalList" @updateList="updateList" :isPrint="isPrint" :isReadonly="board.readonly" :is-often="true" />
  ...
  <print162 v-else :form="form" :board="board" />
</template>
...
import Print162 from "@/views/boards/single-page/162/Print";
