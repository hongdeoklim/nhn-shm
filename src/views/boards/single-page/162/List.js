...
export default {
  getHead: () => {
    return [{name: '현장명'}, {name: '작업내용'}, {name: '재해형태'}, {name: '평가일'}, {name: '소속명'}, {name: '부서명'}, {name: '작성자'}]
  },
  getCol: (index, value, func) => {
    try {
      ...
      case 3: return func.getContent(value).inputB_4 // 평가일시
  ...
  getDefaultSort: () => {
    return {target: 'content$body.inputB_4', order: 'desc'};
  },
  /**
