...
'담당자': ''
    ...
    <vs-row class="mb-4 mt-8" style="display: grid; grid-template-columns: auto 250px 1fr" vs-align="center">
      <vs-col class="title mr-4"><i class="dot"></i> 관리책임자 서명</vs-col>
      <vs-col class="flex" style="justify-content: flex-start">
        <sign-field v-if="!isPrint" :readonly="board.readonly" v-model="form.sign" class="w-full p-1"/>
      </vs-col>
    </vs-row>
...
import NhsafeOrganizationChart from '@/views/boards/single-page/126/NhsafeOrganizationChart'
    ...
    value: {
      ...
      handler(value) {
        ...
        for (const key of keys) {
          if (value[key]) {
            if (key === 'group1' && value[key].length <= 5) {
              // #866b2wbgm 수정전 작성된 문서에 커스텀 row 가 적용되도록 수정
              value[key].splice(2, 0, {no:3, target: "(주)농협네트웍스", type: "", task: "", name: "", phone: "", note: ""})
  ...
  data() {
    return {
      form: {
        stdInfo: {},
        group1: [
          {no:1, target: "(주)농협네트웍스", type: "안전보건총괄책임자", task: "", name: "", phone: "", note: `■ 안전보건총괄책임자의 직무 등(산업안전보건법 시행령 제53조)
① 안전보건총괄책임자의 직무는 다음 각 호와 같다.
1. 법 제36조에 따른 위험성평가의 실시에 관한 사항
2. 법 제51조 및 제54조에 따른 작업의 중지
3. 법 제64조에 따른 도급 시 산업재해 예방조치
...
③ 사업주는 안전보건총괄책임자를 선임했을 때에는 그 선임 사실 및 제1항 각 호의 직무의 수행내용을 증명할 수 있는 서류를 갖추어 두어야 한다.`},
          ...
          {no:2, target: "(주)농협네트웍스", type: "", task: "", name: "", phone: "", note: ""},
          {no:3, target: "(주)농협네트웍스", type: "", task: "", name: "", phone: "", note: ""},
          {no:4, target: "(주)농협네트웍스", type: "안전관리자(안전)", task: "", name: "", phone: "", note: `■ 안전관리자의 업무 등(산업안전보건법 시행령 제18조)
① 안전관리자의 업무는 다음 각 호와 같다.
1. 법 제24조제1항에 따른 산업안전보건위원회(이하 “산업안전보건위원회”라 한다) 또는 법 제75조제1항에 따른 안전 및 보건에 관한 노사협의체(이하 “노사협의체”라 한다)에서 심의ㆍ의결한 업무와 해당 현장의 법 제25조제1항에 따른 안전보건관리규정(이하 “안전보건관리규정”이라 한다) 및 취업규칙에서 정한 업무
2. 법 제36조에 따른 위험성평가에 관한 보좌 및 지도ㆍ조언
3. 법 제84조제1항에 따른 안전인증대상기계등(이하 “안전인증대상기계등”이라 한다)과 법 제89조제1항 각 호 외의 부분 본문에 따른 자율안전확인대상기계등(이하 “자율안전확인대상기계등”이라 한다) 구입 시 적격품의 선정에 관한 보좌 및 지도ㆍ조언
...
④ 안전관리자는 제1항 각 호에 따른 업무를 수행할 때에는 보건관리자와 협력해야 한다.
⑤ 안전관리자에 대한 지원에 관하여는 제14조제2항을 준용한다. 이 경우 “안전보건관리책임자”는 “안전관리자”로, “법 제15조제1항”은 “제1항”으로 본다.`},
          {no:5, target: "(주)농협네트웍스", type: "관리감독자", task: "", name: "", phone: "", note: `■ 관리감독자의 업무 등(산업안전보건법 시행령 제15조)
① 법 제16조제1항에서 “대통령령으로 정하는 업무”란 다음 각 호의 업무를 말한다.  <개정 2021. 11. 19.>
1. 현장 내 법 제16조제1항에 따른 관리감독자(이하 “관리감독자”라 한다)가 지휘ㆍ감독하는 작업(이하 이 조에서 “해당작업”이라 한다)과 관련된 기계ㆍ기구 또는 설비의 안전ㆍ보건 점검 및 이상 유무의 확인
2. 관리감독자에게 소속된 근로자의 작업복ㆍ보호구 및 방호장치의 점검과 그 착용ㆍ사용에 관한 교육ㆍ지도
3. 해당작업에서 발생한 산업재해에 관한 보고 및 이에 대한 응급조치
...
7. 그 밖에 해당작업의 안전 및 보건에 관한 사항으로서 고용노동부령으로 정하는 사항
② 관리감독자에 대한 지원에 관하여는 제14조제2항을 준용한다. 이 경우 “안전보건관리책임자”는 “관리감독자”로, “법 제15조제1항”은 “제1항”으로 본다.`},
          {no:6, target: "(주)농협네트웍스", type: "관리감독자", task: "", name: "", phone: "", note: `■ 관리감독자의 업무 등(산업안전보건법 시행령 제15조)
① 법 제16조제1항에서 “대통령령으로 정하는 업무”란 다음 각 호의 업무를 말한다.  <개정 2021. 11. 19.>
1. 현장 내 법 제16조제1항에 따른 관리감독자(이하 “관리감독자”라 한다)가 지휘ㆍ감독하는 작업(이하 이 조에서 “해당작업”이라 한다)과 관련된 기계ㆍ기구 또는 설비의 안전ㆍ보건 점검 및 이상 유무의 확인
2. 관리감독자에게 소속된 근로자의 작업복ㆍ보호구 및 방호장치의 점검과 그 착용ㆍ사용에 관한 교육ㆍ지도
3. 해당작업에서 발생한 산업재해에 관한 보고 및 이에 대한 응급조치
