<template>
  <div class="mt-component-form">
    ...
    <div class="nhsafe-grid row-header">
      ...
      <div class="row-header__item">소속명</div>
...
<!--      공종-->
      <div class="item-area">
        <CustomSelector  v-if="!isPrint" :options="['전기', '통신', '수장', '금속', '도장', '철거', '조적', '마감', '직접입력']" v-model="rows.task" :isPrint="isPrint" :readonly="isReadonly" class="w-full flex-1" style="padding: 6px" />
