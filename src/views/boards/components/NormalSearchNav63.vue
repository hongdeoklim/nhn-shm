<template>
  <fragment>
    <search-nav-start-end label="작성일" v-model="nav.inputA_5" />
    <search-nav-item-select label="재해형태" v-model="nav.inputB_2" :list="nav.disasterClassList" name="inputB_2"/>
  </fragment>
</template>
