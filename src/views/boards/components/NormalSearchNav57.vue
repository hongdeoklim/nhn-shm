<template>
  <fragment>
    <search-nav-start-end label="작성일" v-model="nav.inputA_4" />
    <search-nav-item-select label="재해구분" v-model="nav.inputA_5" :list="nav.disasterClassList" name="inputA_5"/>
  </fragment>
</template>
