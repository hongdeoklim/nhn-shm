      ...
      <vx-card>
        ...
        <div id="print-report">
          <div>
            ...
            <p class="title mt-5 mb-5">시설물 개요(중대시민재해용)</p>
            <div class="w-full grid" style="grid-template-columns: 1fr 1fr 1fr; column-gap: 1.5rem;">
              ...
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                ...
                <span v-if="isPrint" class="print-input">{{ cat3 }}</span>
                <vs-select v-else class="w-full" autocomplete v-model="cat3" @change="onChangeCat3">
                  <vs-select-item v-for="option in cat3List" :key="option.cat3" :text="option.cat3" :value="option.cat3" />
                </vs-select>
              </div>
              ...
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                ...
                <span v-if="isPrint" class="print-input">{{ cat4 }}</span>
                <vs-select v-else class="w-full" autocomplete v-model="cat4" @change="onChangeCat4">
              ...
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                ...
                <span v-if="isPrint" class="print-input">{{ form.safety_grade }}</span>
                <ml-input v-else class="w-full flex-1" v-model="form.safety_grade"/>
              </div>
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
              ...
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                ...
                <span v-if="isPrint" class="print-input">{{ form.format }}</span>
                <ml-input v-else class="w-full flex-1" v-model="form.format"/>
              </div>
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
              ...
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                ...
                <span v-if="isPrint" class="print-input">{{ form.scale1 }}</span>
                <ml-input v-else class="w-full flex-1" v-model="form.scale1"/>
              </div>
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                <div class="label-text mr-4">규모2</div>
                <span v-if="isPrint" class="print-input">{{ form.scale2 }}</span>
                <ml-input v-else class="w-full flex-1" v-model="form.scale2"/>
              </div>
              <div class="mb-4" style="display: grid; grid-template-columns: 116px 1fr; align-items: center;">
                <div class="label-text mr-4">규모3</div>
                <span v-if="isPrint" class="print-input">{{ form.scale3 }}</span>
                <ml-input v-else class="w-full flex-1" v-model="form.scale3"/>
              </div>
            </div>
          </div>

          <!-- 담당 부서 및 하도급업체 현황 -->
          <company-add-module v-model="companyList" :isPrint="isPrint" @remove="removeCompany" :has-admin-permission="hasAdminPermission"/>

          <!-- 참여 인원 정보 -->
          <company-user-auth-module :users="userList" :isPrint="isPrint" v-model="joinUsers" :has-admin-permission="hasAdminPermission"/>
          ...
          <file-upload-module v-model="fileList" :isPrint="isPrint || !hasAdminPermission" />
        </div>
