      ...
      <div>
        ...
        <vx-card>
          ...
          <div class="grid grid-cols-12 gap-x-10 mt-8 mb-5">
              ...
              >
                ...
                <template slot-scope="{ data }">
                  <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td> {{ data[indextr].work_begin_at }} ~ {{ data[indextr].work_end_at }}</vs-td>
            ...
            <div class="col-span-12">
              <div class="flex items-center justify-between">
                <p class="title ">현장 개요</p>
              </div>
              <div class="mt-5">
                <div class="grid grid-cols-12 gap-x-6 gap-y-4">
                  <div class="col-span-4 flex items-center">
                    <div class="label-text mr-4">현장(장소)명</div>
                    <ml-input
                      class="w-full flex-1"
                      v-model="selectedField.field_name"
                      :readonly="true"
                    />
                  </div>
                  <div class="col-span-4 flex items-center">
                    ...
                    <ml-input
                      class="w-full flex-1"
                      v-model="selectedField.deposit_amount"
                      :readonly="true"
                    />
                  </div>
                  <div class="col-span-4 flex items-center">
                  ...
                  <div class="col-span-4 flex items-center">
                    ...
                    <div class="w-full flex flex-1">
                      <date-selector v-model="selectedField.work_begin_at" :readonly="true"/>
                      <label class="px-2 flex" style="align-items: center">~</label>
                      <date-selector v-model="selectedField.work_end_at" :readonly="true"/>
                    </div>
                  </div>
                  <div class="col-span-4 flex items-center">
                    <div class="label-text mr-4">대표번호</div>
    ...
    loadCompanyInfo () {
      this.$store.dispatch('company/LOAD_COMPANY', {companyId: this.selectedCompanyId}).then(value => {
        ...
        if (this.companyInfo.id) {
          ...
          this.$store.dispatch('company/LOAD_COMPANY_FIELD', {companyId, projectId, fieldType: '현장(직접수행)'}).then(value => {
