...
export default {
  ...
  methods:{
    getCol (index, value) {
      ...
      case 3: return this.getContent(value).accidentInvestigationReport.accidentPersonInformation.compensationStatus
      case 4: return this.getContent(value).accidentBasicInfo.accident_approval
      case 5: return this.getContent(value).accidentInvestigationReport.accidentPersonInformation.name
      case 6: return this.getContent(value).accidentInvestigationReport.accidentPersonInformation.disasterClass
      case 7: return this.getContent(value).accidentInvestigationReport.accidentPersonInformation.shanghai
      }
    },
    getContent (data) {
