      ...
      <vs-row class="border" >
        <vs-col>
          <div class="border-top border-left border-right table-display">
            ...
            <span class="title table-center border-left border-bottom" style="grid-row: 1; grid-column: 3/10">보건교육현황</span>

            <span class="title table-center border-left" style="grid-row: 2; grid-column: 3;">정기보건교육</span>
            <span class="title table-center border-left" style="grid-row: 2; grid-column: 4;">채용시 보건교육</span>
            <span class="title table-center border-left" style="grid-row: 2; grid-column: 5">작업내용 변경시 보건교육</span>
            <span class="title table-center border-left" style="grid-row: 2; grid-column: 6">특별보건교육</span>
            <span class="title table-center border-left" style="grid-row: 2; grid-column: 7">관리감독자 보건교육</span>
      ...
      <vs-row class="">
        <vs-col class="border-bottom">
          <div class="border-top border-left border-right table-content" :data="tr" :key="indextr"
            ...
            <span class="table-center border-left">
              <span class="dot" :class="tr['MSDS_보건'] > 0 ? 'blue' : 'red'"></span>
              <span v-if="tr['MSDS_보건'] > 0">
                {{tr['MSDS_보건']}}
              </span>
            </span>
            <span class="table-center border-left">
