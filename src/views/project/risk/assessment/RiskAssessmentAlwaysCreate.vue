        ...
        <vx-card>
          <vs-row class="mb-8">
            ...
            <vs-col class="w-1/2 px-4 flex flex-wrap">
              ...
              <vs-row class="mb-4" style="display: grid; grid-template-columns: 110px 1fr;" vs-align="center">
                <vs-col class="title">{{ $t('project.risk.assessment.always.create.파트너사') }}</vs-col>
                <vs-col>
...
export default {
  name: 'RiskAssessmentAlwaysCreate',
  components: {
  ...
  methods:{
    ...
    handleBackMenu () {
      this.$emit('handleBackMenu', 'always')
    },
