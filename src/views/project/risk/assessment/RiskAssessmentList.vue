      ...
      <vs-col>
        ...
        >
          ...
          <template slot="thead">
            ...
            <vs-th sort-key="created_at"><vs-col vs-type="flex" vs-justify="center">대상기간</vs-col></vs-th>
...
export default {
  ...
  methods: {
    ...
    async loadPostList () {
      ...
      const boardSlug = this.boardSlug // first_risk(id:6)
      ...
      await this.$store.dispatch('approval/LOAD_POST_ALL', {
        ...
        perPage,
        keyword,
        periodTargetBegin, periodTargetEnd, periodDateBegin, periodDateEnd,
    ...
    handleItemClickDetail (data) {
      this.$router.push({path: `${this.rootPath}/risk/assessment/${this.tagKey}/${data.post_id}`})
    },
