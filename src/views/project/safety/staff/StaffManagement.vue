            ...
            <vs-col>
              <div class="border-top border-left border-right table-display-title">
                ...
                <div class="table-display-sub-5">
                  ...
                  <span class="title table-center border-left w-full">TBM</span>
                  <span class="title table-center border-left w-full">여성</span>
                  <span class="title table-center border-left w-full">고령</span>
                  <span class="title table-center border-left w-full">외국인</span>
                </div>
      ...
      for (const item of this.listAll) {
        ...
        if (_temp_values.length === 0) {
          ...
          for (let i = 0; i < _temp_values.length; i++) {
            if (_temp_values[i].com_name === preview.com_name) {
              const index = i
              _temp_values[index].values[created_day - 1] += Number(preview.num_of_all)
            } else {
