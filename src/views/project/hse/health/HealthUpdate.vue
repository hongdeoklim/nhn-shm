      ...
      <vs-row class="flex flex-wrap mb-4">
        ...
        <vs-row class="w-1/3  mb-4 flex" vs-align="center">
          ...
          <vs-col class="w-9/12">
            ...
            <vs-select autocomplete class="selectExample w-full" v-model="form.hse_type_health" :disabled="!isAuthor">
        ...
        <file-upload-module class="w-full mt-8" :readonly="board.readonly" id="bottom" v-model="fileList"/>
  ...
  data () {
    return {
      ...
      form: {
        ...
        writer: '',
        hse_type: 'health',
        hse_type_health: 'regular_health',
        total: '',
        target:'',
        work:'',
        date:'',
      ...
      selectHealthList: [
        { text: '정기보건교육', value: 'regular_health' },
        { text: '채용시 보건교육', value: 'hiring_health' },
        { text: '작업내용 변경시 보건교육', value: 'changing_health' },
        { text: '특별보건교육', value: 'special_health' },
        { text: '관리감독자 보건교육', value: 'supervisor_health' },
        { text: 'MSDS', value: 'material_health' },
        { text: '기타(보건)', value: 'etc_health' }
      ],
    }
  },
  mounted () {
