<template>
  <div>
    ...
    <search-nav @handleSearch="handleSearch">
      ...
      <search-nav-item-keyword label="파트너사" v-model="nav.company" />
      ...
      <vs-col>
        ...
        >
          ...
          <template slot="thead">
            ...
            <vs-th sort-key="post_title" class="w-2/12" ><span class="w-full text-center">현장명</span></vs-th>
            <vs-th sort-key="content$preview.work" class="w-2/12" ><span class="w-full text-center">교육명</span></vs-th>
...
export default {
  ...
  methods: {
    ...
    handleItemClickDetail (data) {
      this.$router.push({path: `${this.rootPath}/hse/list/environ/${data.id}`})
    },
