      ...
      <vs-col>
        ...
        >
          ...
          <template slot="thead">
            ...
            <vs-th sort-key="content$hse_type_safety" class="w-1/12" ><span class="w-full text-center">교육구분</span></vs-th>
...
export default {
  ...
  methods: {
    ...
    handleItemClickDetail (data) {
      this.$router.push({path: `${this.rootPath}/hse/list/safety/${data.id}`})
    },
