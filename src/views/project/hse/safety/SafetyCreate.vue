      ...
      <vs-row class="flex flex-wrap mb-4">
        ...
        <vs-row class="w-1/3  mb-4 flex" vs-align="center">
          ...
          <vs-col class="w-9/12">
            ...
            <vs-select autocomplete class="selectExample w-full" v-model="form.hse_type_safety" :disabled="board.readonly">
...
export default {
  ...
  data () {
    return {
      ...
      selectSafetyList: [
        { text: '정기안전교육', value: '정기안전교육' },
        { text: '채용시 안전교육', value: '채용시 안전교육' },
        { text: '작업내용 변경시 안전교육', value: '작업내용 변경시 안전교육' },
        { text: '특별안전교육', value: '특별안전교육' },
        { text: '관리감독자 안전교육', value: '관리감독자 안전교육' },
        { text: 'MSDS(안전)', value: 'MSDS(안전)' },
        { text: '기타(안전)', value: '기타(안전)' }
      ],
