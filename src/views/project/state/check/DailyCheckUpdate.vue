        ...
        <vx-card>
          <div>
            ...
            <vs-col class="flex flex-wrap mb-4">
              ...
              <vs-row class="w-1/2  mb-4 flex" vs-align="center">
                <vs-col class="w-3/12 title pr-4">점검기간</vs-col>
                <vs-col class="w-4/12">
...
export default {
  ...
  data () {
    return {
      boardSlug: 'environment_check_daily',
      // TODO : 글쓰기 정보 및 권한
      board: {
        slug: 'environment_check_daily',
        statusCode: '', // 문서 상태코드
        writer: {}, //작성자 정보
  ...
  methods: {
    ...
    handleBackMenu () {
      this.$emit('handleBackMenu', 'daily')
    },
