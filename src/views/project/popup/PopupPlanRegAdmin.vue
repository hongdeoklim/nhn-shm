<template>
  <vs-popup id="popupRegAdmin" title="안전보건책임자" :active.sync="popupActiveSync">
    <vs-row>
      <vs-row class="mb-8">
        <vs-col><h5><i class="dot"></i>안전보건책임자 등록</h5></vs-col>
      </vs-row>
      ...
      <vs-col class="flex flex-wrap mb-4 pl-4 pr-4">
        ...
        <vs-row class="w-1/2  mb-4 flex" vs-align="center">
          <vs-col class="w-4/12 title pl-4">직급</vs-col>
          <vs-col class="w-8/12 pr-4">
            <ml-input class="w-full" v-model="form.rank"/>
          </vs-col>
        </vs-row>
        ...
        <vs-row class="w-1/2  mb-4 flex" vs-align="center">
          <vs-col class="w-4/12 title pl-4">교육 이수일</vs-col>
          <vs-col class="w-8/12 pr-4">
...
export default {
  ...
  methods: {
    ...
    handleSelectMember (member) {
      ...
      this.form.department = member.department
      this.form.section = member.section
      this.form.rank = member.rank
    }
  }
}
